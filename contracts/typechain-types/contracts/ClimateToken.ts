...
export namespace ContributionScoreUpdatedEvent {
...
export interface ClimateToken extends BaseContract {
  connect(runner?: ContractRunner | null): ClimateToken;
  waitForDeployment(): Promise<this>;

  interface: ClimateTokenInterface;
  ...
  filters: {
    ...
    "ContributionScoreUpdated(address,uint256)": TypedContractEvent<
      ContributionScoreUpdatedEvent.InputTuple,
      ContributionScoreUpdatedEvent.OutputTuple,
      ContributionScoreUpdatedEvent.OutputObject
    >;
    ContributionScoreUpdated: TypedContractEvent<
      ContributionScoreUpdatedEvent.InputTuple,
      ContributionScoreUpdatedEvent.OutputTuple,
      ContributionScoreUpdatedEvent.OutputObject
    >;
